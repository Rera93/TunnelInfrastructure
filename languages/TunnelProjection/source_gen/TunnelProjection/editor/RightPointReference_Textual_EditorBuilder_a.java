...
/*package*/ class RightPointReference_Textual_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RightPointReference_Textual_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_7n1njk_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_7n1njk_a0");
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createReferencePresentation_0() {
      EditorCell_Property editorCell = EditorCell_RefPresentation.create(getEditorContext(), myNode, myReferencingNode, IReferentPresentationProvider.getDefaultPresentation(LINKS.rightPointConnection$IrX0));
      editorCell.setCellId("ReferencePresentation_7n1njk_a0b0");
      return editorCell;
    }
  }
