...
/*package*/ class LeftPointReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LeftPointReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        IEdgeAccessor accessor = new SNodeEdgeAccessor(node) {
          ...
          private IConnectionEndpointReference endpointFrom = EndpointUtil.createEndpointReferenceForNodeSafe(SNodeOperations.getNodeAncestor(((SNode) _variablesContext.getValue("thisNode")), CONCEPTS.StraightRoad$CO, false, false));
          private IConnectionEndpointReference endpointTo = EndpointUtil.createEndpointReferenceForNodeSafe(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.leftPointConnect$Vlnw));

          {
            ...
            if (reverse) {
              ...
              {
                Tuples._2<IConnectionEndpointReference, IConnectionEndpointReference> _tmp_g8s6fd_b0b0j0a0a1a2a3a8 = MultiTuple.<IConnectionEndpointReference,IConnectionEndpointReference>from(endpointTo, endpointFrom);
                endpointFrom = _tmp_g8s6fd_b0b0j0a0a1a2a3a8._0();
                endpointTo = _tmp_g8s6fd_b0b0j0a0a1a2a3a8._1();
              }
              {
                Tuples._2<EditorCell, EditorCell> _tmp_g8s6fd_c0b0j0a0a1a2a3a8 = MultiTuple.<EditorCell,EditorCell>from(endRoleCell, startRoleCell);
                startRoleCell = _tmp_g8s6fd_c0b0j0a0a1a2a3a8._0();
                endRoleCell = _tmp_g8s6fd_c0b0j0a0a1a2a3a8._1();
              }
              {
                Tuples._2<IShape, IShape> _tmp_g8s6fd_d0b0j0a0a1a2a3a8 = MultiTuple.<IShape,IShape>from(endShape, startShape);
                startShape = _tmp_g8s6fd_d0b0j0a0a1a2a3a8._0();
                endShape = _tmp_g8s6fd_d0b0j0a0a1a2a3a8._1();
              }
            }
          }
        ...
        editorCell.value.setCellId("DiagramConnector_aftilh_a");
