...
/*package*/ class Layout_EditorBuilder_a extends AbstractEditorBuilder {
  private static final Logger LOG = LogManager.getLogger(Layout_EditorBuilder_a.class);
  @NotNull
                  ...
                  public void run() {
                      ...
                      public List<? extends IDiagramElementAccessor> getElements(IAccessorFactory accessorFactory) {
                        ...
                        for (SNode e : Sequence.fromIterable(new Object() {
                          public Iterable<SNode> query() {
                            return SLinkOperations.collect(SLinkOperations.collectMany(SLinkOperations.getChildren(node, LINKS.tunnels$XEk2), LINKS.tunnelConnection$zqNQ), LINKS.leftPoint$jm9$);
                          }
                        }.query())) {
                        ...
                        for (SNode e : Sequence.fromIterable(new Object() {
                          public Iterable<SNode> query() {
                            return SLinkOperations.collect(SLinkOperations.collectMany(SLinkOperations.getChildren(node, LINKS.tunnels$XEk2), LINKS.tunnelConnection$zqNQ), LINKS.rightPoint$jm8A);
                          }
                        }.query())) {
                          elements.addAll(accessorFactory.fromSNode(e, false));
                        }
                        for (SNode e : Sequence.fromIterable(new Object() {
                          public Iterable<SNode> query() {
                            List<SNode> tunnelConnections = new ArrayList<SNode>();
                            List<SNode> leftPoints = Sequence.fromIterable(SLinkOperations.collect(SLinkOperations.collectMany(SLinkOperations.getChildren(node, LINKS.tunnels$XEk2), LINKS.tunnelConnection$zqNQ), LINKS.leftPoint$jm9$)).toListSequence();
                            for (SNode leftPoint : ListSequence.fromList(leftPoints)) {
                              ListSequence.fromList(tunnelConnections).addElement(SLinkOperations.getTarget(leftPoint, LINKS.leftConnect$JRGP));
                            }
                      ...
                      public List<IConnectionType> getConnectionTypes() {
                        ...
                        connectionTypes.addAll(Collections.singletonList(new GeneratedConnectionType() {
                          ...
                          public void create(final IConnectionEndpoint from, final IConnectionEndpoint to) {
                            ...
                            final SNode toNode = SNodeOperations.cast(to.getSNode(), CONCEPTS.Tunnel$ji);
                            final String fromPort = from.getPortName();
                            final String toPort = to.getPortName();

                            {
                              SNode tunnelRef = SLinkOperations.setNewChild(fromNode, LINKS.leftConnect$JRGP, CONCEPTS.TunnelReference$m9);
                              SLinkOperations.setTarget(tunnelRef, LINKS.leftConnect$ZaFw, toNode);
                            }
                          }
                          @Override
                          ...
                          public boolean isValidEnd(IConnectionEndpoint to) {
                            final SNode toNode = SNodeOperations.as(to.getSNode(), CONCEPTS.Tunnel$ji);
                            if (toNode == null) {
                              return false;
                            }
                            final String toPort = to.getPortName();
                    ...
                    IPaletteEntryProvider paletteEntryProvider = new CompositePaletteEntryProvider(new AbstractPaletteEntryProvider() {
                      ...
                      public Iterable<IPaletteEntry> getEntries() {
                        ...
                        LoggingRuntime.logMsgView(Level.INFO, "REEEEERA", Layout_EditorBuilder_a.class, null, null);
                    ...
                    editorCell.value.setCellId("Diagram_ybaf4h_c0");
