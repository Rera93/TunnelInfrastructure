...
/*package*/ class RightPointReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RightPointReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramConnector_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        IEdgeAccessor accessor = new SNodeEdgeAccessor(node) {
...

          {
            ...
            if (reverse) {
              ...
              {
                Tuples._2<IConnectionEndpointReference, IConnectionEndpointReference> _tmp_d7cis4_b0b0j0a0a1a2a3a8 = MultiTuple.<IConnectionEndpointReference,IConnectionEndpointReference>from(endpointTo, endpointFrom);
                endpointFrom = _tmp_d7cis4_b0b0j0a0a1a2a3a8._0();
                endpointTo = _tmp_d7cis4_b0b0j0a0a1a2a3a8._1();
              }
              {
                Tuples._2<EditorCell, EditorCell> _tmp_d7cis4_c0b0j0a0a1a2a3a8 = MultiTuple.<EditorCell,EditorCell>from(endRoleCell, startRoleCell);
                startRoleCell = _tmp_d7cis4_c0b0j0a0a1a2a3a8._0();
                endRoleCell = _tmp_d7cis4_c0b0j0a0a1a2a3a8._1();
              }
              {
                Tuples._2<IShape, IShape> _tmp_d7cis4_d0b0j0a0a1a2a3a8 = MultiTuple.<IShape,IShape>from(endShape, startShape);
                startShape = _tmp_d7cis4_d0b0j0a0a1a2a3a8._0();
                endShape = _tmp_d7cis4_d0b0j0a0a1a2a3a8._1();
              }
            }
          }
        ...
        editorCell.value.setCellId("DiagramConnector_ej2hai_a");
