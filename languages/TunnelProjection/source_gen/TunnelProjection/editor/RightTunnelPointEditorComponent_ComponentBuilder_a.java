...
/*package*/ class RightTunnelPointEditorComponent_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RightTunnelPointEditorComponent_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_9q21aa_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_9q21aa_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.setCellId("RTPEC_property_name");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_9q21aa_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_1() {
    ...
    try {
      ...
      editorCell.setCellId("RTPEC_property_x");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_9q21aa_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_2() {
    ...
    try {
      ...
      editorCell.setCellId("RTPEC_property_y");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createProperty_3() {
    ...
    try {
      ...
      editorCell.setCellId("RTPEC_property_leftToRightDirection");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_5() {
    ...
    editorCell.setCellId("Constant_9q21aa_j0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, LINKS.roadConnection$Bbhk, CONCEPTS.RoadReference$mj, "roadConnection", getEditorContext()) {
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.roadConnection$Bbhk);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createCollection_1() {
      ...
      editorCell.setCellId("Collection_9q21aa_a0k0");
    ...
    /*package*/ static class Inline_Builder1 extends AbstractEditorBuilder {
      ...
      private EditorCell createProperty_4() {
        ...
        try {
          ...
          editorCell.setDefaultText("<no name>");
          editorCell.setCellId("RTPEC_property_name1");
