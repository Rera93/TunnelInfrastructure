...
/*package*/ class RoadReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RoadReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        IEdgeAccessor accessor = new SNodeEdgeAccessor(node) {
          ...
          private IConnectionEndpointReference endpointFrom = (SNodeOperations.isInstanceOf(SNodeOperations.getParent(((SNode) _variablesContext.getValue("thisNode"))), CONCEPTS.Road$CO) ? EndpointUtil.createEndpointReferenceForNodeSafe(SNodeOperations.getNodeAncestor(((SNode) _variablesContext.getValue("thisNode")), CONCEPTS.Road$CO, false, false)) : EndpointUtil.createEndpointReferenceForNodeSafe(SNodeOperations.getNodeAncestor(((SNode) _variablesContext.getValue("thisNode")), CONCEPTS.RightTunnelPoint$$f, false, false)));
          private IConnectionEndpointReference endpointTo = EndpointUtil.createEndpointReferenceForNodeSafe(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.roadReference$FS6w));

          {
            ...
            if (reverse) {
              ...
              {
                Tuples._2<IConnectionEndpointReference, IConnectionEndpointReference> _tmp_n67icu_b0b0j0a0a1a2a3a8 = MultiTuple.<IConnectionEndpointReference,IConnectionEndpointReference>from(endpointTo, endpointFrom);
                endpointFrom = _tmp_n67icu_b0b0j0a0a1a2a3a8._0();
                endpointTo = _tmp_n67icu_b0b0j0a0a1a2a3a8._1();
              }
              {
                Tuples._2<EditorCell, EditorCell> _tmp_n67icu_c0b0j0a0a1a2a3a8 = MultiTuple.<EditorCell,EditorCell>from(endRoleCell, startRoleCell);
                startRoleCell = _tmp_n67icu_c0b0j0a0a1a2a3a8._0();
                endRoleCell = _tmp_n67icu_c0b0j0a0a1a2a3a8._1();
              }
              {
                Tuples._2<IShape, IShape> _tmp_n67icu_d0b0j0a0a1a2a3a8 = MultiTuple.<IShape,IShape>from(endShape, startShape);
                startShape = _tmp_n67icu_d0b0j0a0a1a2a3a8._0();
                endShape = _tmp_n67icu_d0b0j0a0a1a2a3a8._1();
              }
            }
          }
          ...
          @Override
          public void delete() {
            if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(((SNode) _variablesContext.getValue("thisNode"))), CONCEPTS.Road$CO)) {
              SPropertyOperations.set(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.roadReference$FS6w), PROPS.isConnected$uhEN, false);
            }
        ...
        editorCell.value.setCellId("DiagramConnector_pwt5bk_a");
