...
/*package*/ class LeftTunnelPoint_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LeftTunnelPoint_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        final IShape shape = new Circle(SPropertyOperations.getBoolean(((SNode) _variablesContext.getValue("thisNode")), PROPS.entryPoint$oI16));
        ...
        editorCell.value.setCellId("DiagramNode_2nbzmd_a");
  ...
  private EditorCell createEmpty_0() {
    ...
    editorCell.setCellId("Empty_2nbzmd_a0");
    return editorCell;
  }
