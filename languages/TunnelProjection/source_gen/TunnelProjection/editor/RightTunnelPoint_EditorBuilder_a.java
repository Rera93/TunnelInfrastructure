...
/*package*/ class RightTunnelPoint_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RightTunnelPoint_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        final IShape shape = new Circle(SPropertyOperations.getBoolean(((SNode) _variablesContext.getValue("thisNode")), PROPS.entryPoint$oHNz));
        ...
        editorCell.value.setCellId("DiagramNode_z1hra8_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_z1hra8_a0");
