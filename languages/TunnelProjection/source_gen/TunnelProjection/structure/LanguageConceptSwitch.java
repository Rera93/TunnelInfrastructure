...
public final class LanguageConceptSwitch {
  ...
  public static final int LeftPointReference = 1;
  public static final int LeftTunnelPoint = 2;
  public static final int RightPointReference = 3;
  public static final int RightTunnelPoint = 4;
  public static final int Road = 5;
  public static final int RoadProperties = 6;
  public static final int RoadReference = 7;
  public static final int Semaphore = 8;
  public static final int Tunnel = 9;
  public static final int TunnelHole = 10;
  public static final int TunnelHoleReference = 11;
  public static final int TunnelLayout = 12;
  public static final int TunnelRoad = 13;
  public static final int TunnelRoadReference = 14;

  public LanguageConceptSwitch() {
    LanguageConceptIndexBuilder builder = new LanguageConceptIndexBuilder(0x72c81d76425049a4L, 0x8dfa274e9e7a2b19L);
    builder.put(0x261858895fee0a81L, Beam);
    ...
    builder.put(0x261858895fee0a7eL, Semaphore);
