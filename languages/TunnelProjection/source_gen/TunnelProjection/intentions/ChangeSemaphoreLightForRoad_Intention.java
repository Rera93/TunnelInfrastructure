...
public final class ChangeSemaphoreLightForRoad_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  public ChangeSemaphoreLightForRoad_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:2b869ca2-ccf5-4cfa-ac42-87fb5d120400(TunnelProjection.intentions)", "3321041496537694166"));
  }
  @Override
  public String getPresentation() {
    return "ChangeSemaphoreLightForRoad";
  }
  @Override
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    return (SLinkOperations.getTarget(node, LINKS.hasSemaphore$DTpI) != null);
  }
  @Override
  ...
  private List<SEnumerationLiteral> parameter(final SNode node, final EditorContext editorContext) {
    if (SEnumOperations.isMember(SPropertyOperations.getEnum(SLinkOperations.getTarget(node, LINKS.hasSemaphore$DTpI), PROPS.currentLight$jETz), 0x261858895ffc2fe7L)) {
    ...
    } else if (SEnumOperations.isMember(SPropertyOperations.getEnum(SLinkOperations.getTarget(node, LINKS.hasSemaphore$DTpI), PROPS.currentLight$jETz), 0x261858895ffc2fe8L)) {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable implements ParameterizedIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      switch (enumSwitchIndex_csn6iy_a0a0d7.indexNullable(myParameter)) {
        case 0:
          SPropertyOperations.setEnum(SLinkOperations.getTarget(node, LINKS.hasSemaphore$DTpI), PROPS.currentLight$jETz, 0x261858895ffc2fe7L, "Green");
          break;
        case 1:
          SPropertyOperations.setEnum(SLinkOperations.getTarget(node, LINKS.hasSemaphore$DTpI), PROPS.currentLight$jETz, 0x261858895ffc2fe8L, "Orange");
          break;
        case 2:
          SPropertyOperations.setEnum(SLinkOperations.getTarget(node, LINKS.hasSemaphore$DTpI), PROPS.currentLight$jETz, 0x261858895ffc2febL, "Red");
          break;
      }
    }
    @Override
    public IntentionDescriptor getDescriptor() {
      return ChangeSemaphoreLightForRoad_Intention.this;
    }
    public Object getParameter() {
      return myParameter;
    }
  }
  private static final EnumerationLiteralsIndex enumSwitchIndex_csn6iy_a0a0d7 = EnumerationLiteralsIndex.build(0x72c81d76425049a4L, 0x8dfa274e9e7a2b19L, 0x261858895ffc2fe6L, 0x261858895ffc2fe7L, 0x261858895ffc2fe8L, 0x261858895ffc2febL);
