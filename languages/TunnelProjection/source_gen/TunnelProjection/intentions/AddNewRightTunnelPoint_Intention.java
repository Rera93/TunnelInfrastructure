...
public final class AddNewRightTunnelPoint_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  public AddNewRightTunnelPoint_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:2b869ca2-ccf5-4cfa-ac42-87fb5d120400(TunnelProjection.intentions)", "807341396989021822"));
  }
  @Override
  public String getPresentation() {
    return "AddNewRightTunnelPoint";
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable implements ParameterizedIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Add New Right Point To " + myParameter + " Tunnel Hole";
    }
    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      for (SNode hole : ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.holes$OmIQ))) {
        if (SPropertyOperations.getString(hole, PROPS.name$tAp1) == SPropertyOperations.getString(myParameter, PROPS.name$tAp1)) {
          ListSequence.fromList(SLinkOperations.getChildren(hole, LINKS.rightPoints$jm8A)).addElement(SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x72c81d76425049a4L, 0x8dfa274e9e7a2b19L, 0x1269a46804bfb76fL, "TunnelProjection.structure.RightTunnelPoint")));
        }
      }
    }
    @Override
    public IntentionDescriptor getDescriptor() {
      return AddNewRightTunnelPoint_Intention.this;
    }
